...
module.exports.models = {
  ...
  ***************************************************************************/
  ...
  attributes: {
    id: { type: 'number', autoIncrement: true, columnType:'bigint(20)' },
    bsCreatedAt: { type: 'number', columnName:'bsc_created_at', autoCreatedAt: true, columnType:'bigint(16)'},
    bsUpdatedAt: { type: 'number', columnName:'bsc_updated_at',  autoUpdatedAt: true, columnType:'bigint(16)'},
    bsMetaType: { type: 'number', columnName:'bsc_meta_type', columnType: 'int(12)' },
    bsIsUse: { type: 'boolean', columnName:'bsc_is_use', columnType:'tinyint(1)'},
    bsRegion: { type: 'number', columnName:'bsc_region', columnType: 'int(8)' },
    bsVersion: { type: 'number', columnName:'bsc_version', columnType: 'int(12)' },
  ...
  ******************************************************************************/
  ...
  dataEncryptionKeys: {
    default: '4hdLtKYQsTDSwYG3oyHryaxtANFfGSo9pqTW5VMZ/RE='
  },
